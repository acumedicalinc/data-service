...
insert into users(username,password,enabled) values('frank','cGFzc3dvcmQ=',true);
insert into users(username,password,enabled) values('julia','cGFzc3dvcmQ=',true);
...
insert into authorities(username,authority) values('julia','admin');
insert into authorities(username,authority) values('frank','superadmin');
